...
<template>
    ...
    <section v-else class="flex overflow-x-auto">
        <div class="flex min-w-full min-h-60 space-x-4">
            <div v-for="p in players" 
                :key="p.Nickname" 
                class="relative flex-shrink-0 flex flex-col justify-end dark:bg-slate-950 bg-slate-100 rounded-lg overflow-hidden w-52 border-2 mb-2" 
            >
                ...
                <div class="flex flex-col items-start -mt-16 p-4">
                    <div class="flex justify-between w-full mb-4">
                        ...
                        <span class="flex justify-end"><Badge>{{ p.Stats.Elo }}</Badge></span>
                    </div>
